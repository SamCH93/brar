...
the approximate normal method from Section~3 and the exact binomial method from
Section~4 in the main text. The following code chunk illustrates how the latter
