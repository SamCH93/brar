...
explorable results dashboard
(\url{https://brar-42c2c0.pages.uzh.ch/simulation-dashboard.html}).
...
details and results is provided at \url{https://github.com/SamCH93/brar}.
%% TODO: update link to GitHub pages website when live
